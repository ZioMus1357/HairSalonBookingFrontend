...
import { Appointment, AppointmentRequest, CreateAppointmentRequest } from "../types/domain";

export const appointmentsApi = {
  all: () => request<Appointment[]>("/api/Appointments"),
  byId: (id: string) => request<Appointment>(`/api/Appointments/${id}`),
  create: (body: CreateAppointmentRequest) => request<Appointment>("/api/Appointments", { method: "POST", body: asJson(body) }),
